...
export const BottomNavbar: FC = () => {
  ...
  return (
    <nav className="shadow-t dark:shadow-t-gray-800 fixed bottom-0 left-0 right-0 z-50 mx-6 flex h-[5.625rem] w-auto items-center justify-between bg-white dark:bg-gray-900">
      {NAV_ITEMS.map((item) => {
