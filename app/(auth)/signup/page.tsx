        ...
        <div className="flex min-h-screen flex-col items-center">
            {step === Step.Role && (
                <>
                    ...
                    />
                    <div className="font-semibold text-[20px] mt-[5rem]">
                        <p>현재 어떤 직종에</p>
                        <p>일하고 계신가요?</p>
                    </div>
            ...
            {step === Step.Guide && (
                <>
                    ...
                    <div className="mt-[1rem] flex w-[90%] flex-col items-center gap-[12px]">
                        ...
                        <div className="mt-[1rem] mb-[3rem] flex h-[200px] w-full items-center justify-center">
                            <img src={`${roleImg}`} />
                        </div>
                ...
                {route === "학생" ? (
                    <>
                        ...
                        <div className="mt-[1rem] flex w-[90%] flex-col">
                            ...
                            <div className="w-full mt-[2rem] flex flex-col gap-[15px] item-center justify-center">
                        ...
                        <>
                            ...
                            <div className="mt-[1rem] flex w-[90%] flex-col">
                                ...
                                <div className="w-full mt-[8rem] flex flex-col gap-[15px]">
                                    <StrokeButton content="다시 촬영하기" Color="#FF412E" />
                                    <SolidButton content="인증하기" bgColor="#FF412E" />
                                </div>
                            </div>
            ...
            {step === Step.ServiceRule && (
                <>
                    ...
                    <div className="flex w-[90%] flex-col items-center">
                        <textarea
                            className="scrollbar-hide h-[450px] w-full gap-[2rem] overflow-y-auto whitespace-pre-wrap text-[13px] font-medium bg-white"
                            readOnly
                            disabled
