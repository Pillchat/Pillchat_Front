...
function Footer() {
    ...
    const pathname = typeof window !== "undefined" ? window.location.pathname || "/" : "/"; // 초기값을 "/"로 설정
    ...
    return (
        <S.FooterCover>
            <BsFillPeopleFill size={25} color={getIconColor("/geshipan")} onClick={() => router.push("/geshipan")} onTouchStart={(e) => e.stopPropagation()} />
            ...
            <FaBookOpen size={25} color={getIconColor("/Archaive")} onClick={() => router.push("/Archaive")} onTouchStart={(e) => e.stopPropagation()} />
