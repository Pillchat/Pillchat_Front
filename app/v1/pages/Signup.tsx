    ...
    <S.Container>
      ...
      <S.InputBox>
        ...
        <S.ContainBox>
          ...
          <S.ContainSelect onChange={(e) => setGrade(e.target.value)} required>
        ...
        <S.ContainBox>
          ...
          <S.ContainInputSmall
            ...
            required
          />
          {idError && <S.ErrorIdMessage>{idError}</S.ErrorIdMessage>}{" "}
          {/* 아이디 중복 오류 메시지 */}
        </S.ContainBox>
        ...
        <S.ContainBox>
          ...
          {passwordError && (
            <S.PwErrorMessage>{passwordError}</S.PwErrorMessage>
          )}{" "}
          {/* 비밀번호 오류 메시지 */}
        </S.ContainBox>
      ...
      <S.Gologin onClick={() => router.push("/Signin")}>
        로그인 하러 가기
      </S.Gologin>
    </S.Container>
  );
