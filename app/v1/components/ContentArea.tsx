...
import * as S from "../styles/ContentArea";

interface QuestionAreaProps {
  content: string; // 표시할 텍스트 내용
}

const ContentArea: React.FC<QuestionAreaProps> = ({ content }) => {
  ...
  return <S.Content ref={textareaRef} value={content} readOnly disabled />;
};
